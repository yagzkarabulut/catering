  ...
  k.prototype = {
    ...
    getClassNames: function (b) {
      ...
      return (
        ...
        (!this.dateWithinRange(b) || this.dateIsDisabled(b)) &&
          c.push("disabled"),
      ...
      if (!isNaN(f) && !isNaN(g)) {
        ...
        for (
          ...
          if (
            ...
            -1 !== a.inArray(f, F) && E.push("active"),
            (h > f || f > j) && E.push("disabled"),
    ...
    click: function (b) {
      ...
      var e,
        f,
        g,
        h = a(b.target).closest("span, td, th");
      if (1 === h.length)
              ...
              h.hasClass("month")
                ? ((g = 1),
                  ...
                  1 === this.o.minViewMode
                    ? (this._setDate(c(e, f, g)), this.showMode())
                    : this.showMode(-1))
                : ((g = 1),
                  (f = 0),
                  ...
                  this._trigger("changeYear", this.viewDate),
                  2 === this.o.minViewMode && this._setDate(c(e, f, g)),
                  this.showMode(-1)),
              this.fill());
            break;
          case "td":
    ...
    r = {
      ...
      parseDate: function (e, f, g) {
        ...
        if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(e)) {
          for (e = new Date(), l = 0; l < o.length; l++)
            (i = n.exec(o[l])),
              (j = parseInt(i[1])),
              (m = p[i[2]]),
              (e = k.prototype[m](e, j));
        ...
        if (
          ...
          for (l = 0, y = x.length; y > l; l++) {
            if (((s = parseInt(o[l], 10)), (i = x[l]), isNaN(s)))
              switch (i) {
                case "MM":
          ...
          for (l = 0; l < v.length; l++)
            (A = v[l]),
              A in u &&
                !isNaN(u[A]) &&
                ((z = new Date(e)), w[A](z, u[A]), isNaN(z) || (e = z));
        }
        return e;
      },
