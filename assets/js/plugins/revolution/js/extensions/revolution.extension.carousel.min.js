        ...
        jQuery.each(s.slides, function (i, a) {
          ...
          var d =
              "center" === s.horizontal_align
                ? (Math.abs(s.wrapwidth / 2) - (n.left + s.slide_width / 2)) /
                  s.slide_width
          ...
          if (
            ...
            if ("on" === s.vary_fade)
              n.autoAlpha =
                1 - Math.abs((1 / Math.ceil(s.maxVisibleItems / h)) * d);
            else
              switch (s.horizontal_align) {
                case "center":
                  n.autoAlpha =
                    Math.abs(d) < Math.ceil(s.maxVisibleItems / h - 1)
                      ? 1
                ...
                case "left":
                  n.autoAlpha =
                    1 > d && d > 0
                      ? 1 - d
                      : Math.abs(d) > s.maxVisibleItems - 1
                      ? 1 - (Math.abs(d) - (s.maxVisibleItems - 1))
                      : 1;
                  break;
                case "right":
                  n.autoAlpha =
            ...
            n.autoAlpha =
              Math.abs(d) < Math.ceil(s.maxVisibleItems / h) ? 1 : 0;
          if (void 0 !== s.minScale && s.minScale > 0)
            if ("on" === s.vary_scale) {
              n.scale =
                1 -
                Math.abs(
                  (s.minScale / 100 / Math.ceil(s.maxVisibleItems / h)) * d
                );
          ...
          void 0 !== s.maxRotation &&
            ...
            ("on" === s.vary_rotation
              ? ((n.rotationY =
                ...
                (n.autoAlpha = Math.abs(n.rotationY) > 90 ? 0 : n.autoAlpha))
              : (n.rotationY =
                  d >= 1 || -1 >= d
                    ? s.maxRotation
    ...
    r = function (e) {
      ...
      if (
        ...
        (o = i.simp(o, e.slideamount, !1)),
          ...
          (s = s >= 0 ? s : 0),
          (t = "off" === a.infinity ? o - s : -l(o, s, e.slideamount)),
          (t *= a.slide_width);
      }
      return t;
    };
