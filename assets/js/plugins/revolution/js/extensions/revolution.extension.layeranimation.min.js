...
!(function () {
  ...
  jQuery.extend(!0, e, {
    ...
    animateSingleCaption: function (i, o, m, f, w, y, b) {
      ...
      if (
        (i.data("_pw") ||
          (i.data("_pw", L), i.data("_lw", W), i.data("_mw", C)),
        "fullscreen" == o.sliderLayout &&
          (f = _ / 2 - (o.gridheight[o.curWinRange] * o.bh) / 2),
        ("on" == o.autoHeight || (void 0 != o.minHeight && o.minHeight > 0)) &&
          (f = o.conh / 2 - (o.gridheight[o.curWinRange] * o.bh) / 2),
        0 > f && (f = 0),
        o.debugMode)
      ) {
        i.closest("li")
      ...
      var Q =
        l(i.data("visibility"), o)[o.curWinRange] ||
        l(i.data("visibility"), o) ||
        "on";
      if (
        ("off" == Q ||
        (k < o.hideCaptionAtLimit && "on" == i.data("captionhidden")) ||
        k < o.hideAllCaptionAtLimit
          ? i.addClass("tp-hidden-caption")
          : i.removeClass("tp-hidden-caption"),
        i.data("layertype", "html"),
        0 > m && (m = 0),
        void 0 != i.data("thumbimage") &&
          void 0 == i.data("videoposter") &&
          i.data("videoposter", i.data("thumbimage")),
        i.hasClass("tp-videolayer") &&
          void 0 != i.data("videoposter") &&
          "on" == i.data("posterOnMobile") &&
          _ISM)
      ) {
        var M =
            l(i.data("videowidth"), o)[o.curWinRange] ||
            l(i.data("videowidth"), o) ||
            "auto",
          O =
            l(i.data("videoheight"), o)[o.curWinRange] ||
            l(i.data("videoheight"), o) ||
            "auto";
        (M = parseFloat(B)),
          (O = parseFloat(F)),
          i.append(
      ...
      if (i.find("img").length > 0) {
        ...
        void 0 == B && (B = 0),
          void 0 == F && (F = 0),
          "off" !== j
            ? (H.width("grid" != I && P ? B : B * o.bw),
              H.height("grid" != I && X ? F : F * o.bh))
            : (H.width(B), H.height(F));
      }
      if (
        ("slide" === I && ((m = 0), (f = 0)),
        i.hasClass("tp-videolayer") ||
        ...
        if (
          (i.data("layertype", "video"),
          e.manageVideoLayer(i, o, y, x),
          !y && !x)
        ) {
          {
            i.data("videotype");
        ...
        (B = parseFloat(B)),
          (F = parseFloat(F)),
          void 0 === i.data("cssobj") && ((G = c(i, 0)), i.data("cssobj", G));
        var U = g(i.data("cssobj"), o);
        if (
          ("auto" == U.lineHeight && (U.lineHeight = U.fontSize + 4),
          i.hasClass("fullscreenvideo") || $)
        ) {
        ...
        ((0 == Z && !$) ||
          (1 != i.data("forcecover") &&
            !i.hasClass("fullscreenvideo") &&
            !$)) &&
          (H.width(B * o.bw), H.height(F * o.bh));
      }
      ...
      if (void 0 === K) {
        var K = new Object();
        (K.voa =
          l(i.data("voffset"), o)[o.curWinRange] || l(i.data("voffset"), o)[0]),
          (K.hoa =
            l(i.data("hoffset"), o)[o.curWinRange] ||
            l(i.data("hoffset"), o)[0]),
      ...
      b ||
        ...
        void 0 == i.data("timeline") ||
          x ||
          (2 != T && i.data("timeline").gotoAndPlay(0), (x = !0)),
        !y &&
          i.data("timeline_out") &&
          2 != T &&
          0 != T &&
          (i.data("timeline_out").kill(), i.data("outstarted", 0)),
        b &&
          void 0 != i.data("timeline") &&
          (i.removeData("$anims"),
          i.data("timeline").pause(0),
          i.data("timeline").kill(),
          void 0 != i.data("newhoveranim") &&
            (i.data("newhoveranim").progress(0), i.data("newhoveranim").kill()),
      ...
      if (
        ((ye = jQuery.isNumeric(ye) ? ye : 0),
        be.pause(),
        (1 > ye && 1 != i.data("outstarted")) || 2 == T || b)
      ) {
        var xe = i;
        if (
          (void 0 != i.data("mySplitText") && i.data("mySplitText").revert(),
          (void 0 != i.data("splitin") &&
            i.data("splitin").match(/chars|words|lines/g)) ||
            (void 0 != i.data("splitout") &&
              i.data("splitout").match(/chars|words|lines/g)))
        ) {
          var Te = i.find("a").length > 0 ? i.find("a") : i;
          i.data(
            "mySplitText",
            new punchgs.SplitText(Te, {
        ...
        void 0 !== i.data("mySplitText") &&
          i.data("splitin") &&
          i.data("splitin").match(/chars|words|lines/g) &&
          (xe = i.data("mySplitText")[i.data("splitin")]);
        var Le = new Object(),
          We =
            void 0 != i.data("transform_in")
              ? i.data("transform_in").match(/\(R\)/gi)
              : !1;
        if (!i.data("$anims") || b || We) {
          var Ce = t(),
            ...
            Re = n(),
            Ie =
              void 0 !== i.data("transform_hover") ||
              void 0 !== i.data("style_hover");
          (je = d(je, i.data("transform_idle"))),
            (Ce = d(je, i.data("transform_in"), 1 == o.sdir)),
            Ie &&
              ((Re = d(Re, i.data("transform_hover"))),
              (Re = h(Re, i.data("style_hover"))),
              i.data("hover", Re)),
            (Ce.elemdelay =
              void 0 == i.data("elementdelay") ? 0 : i.data("elementdelay")),
            (je.anim.ease = Ce.anim.ease =
              Ce.anim.ease || punchgs.Power1.easeInOut),
            Ie &&
        ...
        if (
          ((Le.f.anim.x =
            Le.f.anim.x * o.bw ||
            r(Le.f.anim.x, o, ne, oe, ve, ue, "horizontal")),
          (Le.f.anim.y =
            Le.f.anim.y * o.bw ||
            r(Le.f.anim.y, o, ne, oe, ve, ue, "vertical")),
          2 != T || b)
        ) {
          if (xe != i) {
            var ze = Le.r.anim.ease;
            be.add(punchgs.TweenLite.set(i, Le.r.anim)),
              (Le.r = t()),
              (Le.r.anim.ease = ze);
          }
          if (
            ...
            _e.eventCallback("onStart", function () {
              ...
              (a.layer = i),
                ...
                (a.layertype = i.data("layertype")),
                (a.layersettings = i.data()),
                o.c.trigger("revolution.layeraction", a);
            }),
            ...
            (Se.ease = Le.r.anim.ease),
              ...
              (ke.anim.x =
                ke.anim.x * o.bw ||
                r(ke.anim.x, o, ne, oe, ve, ue, "horizontal")),
              (ke.anim.y =
                ke.anim.y * o.bw ||
                r(ke.anim.y, o, ne, oe, ve, ue, "vertical")),
              be.add(
            ...
            be.add(
              punchgs.TweenLite.set(C, { overflow: "visible" }, Ce.elemdelay),
              0
            );
        }
        i.data("timeline", be),
          ...
          ("sliderenter" != ce || ("sliderenter" == ce && o.overcontainer)) &&
            (-1 == T ||
              1 == T ||
              b ||
              (0 == T && 1 > ye && i.hasClass("rev-static-visbile"))) &&
            ((1 > ye && ye > 0) ||
              (0 == ye && "bytrigger" != ce && "keep" != pe) ||
              (0 == ye && "bytrigger" != ce && "keep" == pe && "on" == he) ||
              ("bytrigger" == ce && "keep" == pe && "on" == he)) &&
            be.resume(we);
      }
      "on" == i.data("loopanimation") &&
        punchgs.TweenLite.set(W, { minWidth: ne, minHeight: oe }),
        0 == i.data("slidelink") ||
        (1 != i.data("slidelink") && !i.hasClass("slidelink"))
    ...
    endMoveCaption: function (a, e, n, o) {
      ...
      var l = new punchgs.TimelineLite(),
        ...
        g = a.data("transform_out")
          ? d(i(), a.data("transform_out"), 1 == o.sdir)
          : d(i(), a.data("transform_in"), 1 == o.sdir),
        m =
      ...
      (g.anim.x =
        g.anim.x * o.bw || r(g.anim.x, o, v, f, w.top, w.left, "horizontal")),
        (g.anim.y =
          g.anim.y * o.bw || r(g.anim.y, o, v, f, w.top, w.left, "vertical")),
        ...
        y
          ? ((y.anim.ease = g.anim.ease),
            ...
            (y.anim.x =
              y.anim.x * o.bw ||
              r(y.anim.x, o, v, f, w.top, w.left, "horizontal")),
            (y.anim.y =
              y.anim.y * o.bw ||
              r(y.anim.y, o, v, f, w.top, w.left, "vertical")),
          ...
          jQuery.each(n, function (a, e) {
            ...
            t &&
              ...
              void 0 != d &&
                ((d = d.replace(/\(R\)/, "")),
                ("rotationX" == r || "rX" == r) &&
                  (i.anim.rotationX = o(d, i.anim.rotationX) + "deg"),
                ("rotationY" == r || "rY" == r) &&
                  (i.anim.rotationY = o(d, i.anim.rotationY) + "deg"),
                ("rotationZ" == r || "rZ" == r) &&
                  (i.anim.rotation = o(d, i.anim.rotationZ) + "deg"),
                ("scaleX" == r || "sX" == r) &&
                  (i.anim.scaleX = o(d, i.anim.scaleX)),
                ("scaleY" == r || "sY" == r) &&
                  (i.anim.scaleY = o(d, i.anim.scaleY)),
                ("opacity" == r || "o" == r) &&
                  (i.anim.opacity = o(d, i.anim.opacity)),
                ("skewX" == r || "skX" == r) &&
                  (i.anim.skewX = o(d, i.anim.skewX)),
                ("skewY" == r || "skY" == r) &&
                  (i.anim.skewY = o(d, i.anim.skewY)),
