...
!(function () {
    ...
    resizeThumbsTabs: function (t) {
      if (
        ...
        i.pause(),
          ...
          h(s) &&
            s.width > s.min_width &&
            a(e, i, t.c, s, t.slideamount, "thumb"),
          i.play(),
          x(t);
      }
      return !0;
  ...
  var i = function (t, e) {
      var i =
        ...
        d =
          "vertical" === o
            ? s.find(n).first().outerHeight(!0) + e.space
            : s.find(n).first().outerWidth(!0) + e.space,
      ...
      var r = i.parent().find(".tp-" + s + "s"),
        ...
        c =
          "vertical" === a.direction
            ? { width: l + "px" }
            : { height: h + "px" };
      e.add(punchgs.TweenLite.set(r, c)),
        ...
        jQuery(document).keydown(function (a) {
          (("horizontal" == i.navigation.keyboard_direction &&
            ...
            ("vertical" == i.navigation.keyboard_direction &&
              40 == a.keyCode)) &&
            ((i.sc_indicator = "arrow"), t.callingNewSlide(i, e, 1)),
            (("horizontal" == i.navigation.keyboard_direction &&
              37 == a.keyCode) ||
              ("vertical" == i.navigation.keyboard_direction &&
                38 == a.keyCode)) &&
        ...
        e.on("mousewheel DOMMouseScroll", function (r) {
          ...
          if (-1 == l) {
            if (o.pixelY < a) {
              if (!h)
                return (
                  (i.sc_indicator = "arrow"), t.callingNewSlide(i, e, -1), !1
                );
            } else if (o.pixelY > s && !p)
              return (i.sc_indicator = "arrow"), t.callingNewSlide(i, e, 1), !1;
          } else if (!p) return !1;
          r.preventDefault();
        });
      }
          ...
          swipeStatus: function (e, n, r, d) {
            ...
            if (
              ...
              switch (
                ...
                case "start":
                  void 0 !== s.positionanim &&
                    (s.positionanim.kill(),
                    (s.slide_globaloffset =
                      "off" === s.infinity
                        ? s.slide_offset
                        : t.simp(s.slide_offset, s.maxwidth))),
                    (s.overpull = "none"),
                ...
                case "move":
                  if (
                    ((s.slide_offset =
                      "off" === s.infinity
                        ? s.slide_globaloffset + d
                        : t.simp(s.slide_globaloffset + d, s.maxwidth)),
                    "off" === s.infinity)
                  ) {
                    var g =
                    ...
                    ("none" !== s.overpull && 0 !== s.overpull) ||
                    !(0 > g || g > a.slideamount - 1)
                      ? g >= 0 &&
                        g <= a.slideamount - 1 &&
                        ((g >= 0 && d > s.overpull) ||
                          (g <= a.slideamount - 1 && d < s.overpull)) &&
                        (s.overpull = 0)
                      : (s.overpull = d),
                      (s.slide_offset =
                        0 > g
                          ? s.slide_offset +
                            (s.overpull - d) / 1.1 +
                            Math.sqrt(Math.abs((s.overpull - d) / 1.1))
                          : g > a.slideamount - 1
                          ? s.slide_offset +
                            (s.overpull - d) / 1.1 -
                            Math.sqrt(Math.abs((s.overpull - d) / 1.1))
                ...
                case "end":
                case "cancel":
                  (s.slide_globaloffset = s.slide_offset),
                    s.wrap.removeClass("dragged"),
                    t.carouselToEvalPosition(a, r),
              ...
              if (
                ...
                if ("end" == n && !f) {
                  if (
                    ...
                    return t.callingNewSlide(a, a.c, 1), !1;
                  if (
                    ("horizontal" == l && "right" == r) ||
                    ("vertical" == l && "down" == r)
                  )
                    return t.callingNewSlide(a, a.c, -1), !1;
                }
      ...
      if (
        ...
        r > a && "outer-left" !== e.position && "outer-right" !== e.position
          ? (punchgs.TweenLite.set(t, {
            ...
            punchgs.TweenLite.set(d, { maxWidth: a - 2 * s + "px" }))
          : (punchgs.TweenLite.set(t, { maxWidth: r + "px" }),
            punchgs.TweenLite.set(d, { maxWidth: r + "px" })),
          o + 2 * s > n &&
        ...
        x.click(function () {
          ...
          (e = void 0 === e ? 0 : e),
            Math.abs(e) < 10 &&
              ...
              t.parent().find(s).removeClass("selected"),
              jQuery(this).addClass("selected"));
        }),
