...
!(function () {
  ...
  jQuery.extend(!0, e, {
        ...
        : (o.li.each(function () {
            for (var e = jQuery(this), a = 1; 10 >= a; a++)
              e.find(".rs-parallaxlevel-" + a).each(function () {
                ...
                t.data("parallaxlevel", r.levels[a - 1]),
              ...
              switch (e.type) {
                case "mousemove":
                  if ("enterpoint" == r.origo) {
                    var l = t.offset().top,
                      n = t.offset().left;
                    void 0 == a.data("enterx") && a.data("enterx", e.pageX - n),
                      void 0 == a.data("entery") &&
                        a.data("entery", e.pageY - l);
                    var i = a.data("enterx"),
                      s = a.data("entery"),
                      c = i - (e.pageX - n),
                      p = s - (e.pageY - l),
    ...
    scrollHandling: function (t) {
      ...
      (t.lastscrolltop = r),
        (l.top = o - r),
        (l.h = 0 == t.conh ? t.c.height() : t.conh),
        (l.bottom = o - r + l.h);
      var s =
        l.top < 0
          ? l.top / l.h
          : l.bottom > t.lastwindowheight
          ? (l.bottom - t.lastwindowheight) / l.h
          : 0;
      (t.scrollproc = s),
        e.callBackHandling && e.callBackHandling(t, "parallax", "start");
      var c = 1 - Math.abs(s);
      if (
        ((c = 0 > c ? 0 : c),
        n.enable &&
          (1 - n.visible_area <= c
            ? t.inviewport || ((t.inviewport = !0), e.enterInViewPort(t))
            : t.inviewport && ((t.inviewport = !1), e.leaveViewPort(t))),
        a && "on" == t.parallax.disable_onmobile)
      )
        return !1;
        ...
        ("scroll" == i.type ||
          ...
          t.c.find(".tp-parallax-container").each(function () {
            var e = jQuery(this),
              a = parseInt(e.data("parallaxlevel"), 0) / 100,
              o = s * -(a * t.conh);
            e.data("parallaxoffset", o),
              p.add(punchgs.TweenLite.set(e, { force3D: "auto", y: o }), 0);
          }),
        t.c
          .find(
