...
!(function () {
  ...
  var e = function (e, o, a, i) {
    ...
    o = function (t, e, o, a, i) {
      ...
      "slidehorizontal" == o &&
        ((o = "slideleft"), 1 == i && (o = "slideright")),
        "slidevertical" == o && ((o = "slideup"), 1 == i && (o = "slidedown")),
        "slideoverhorizontal" == o &&
          ((o = "slideoverleft"), 1 == i && (o = "slideoverright")),
        "slideoververtical" == o &&
          ((o = "slideoverup"), 1 == i && (o = "slideoverdown")),
        "slideremovehorizontal" == o &&
          ((o = "slideremoveleft"), 1 == i && (o = "slideremoveright")),
        "slideremovevertical" == o &&
          ((o = "slideremoveup"), 1 == i && (o = "slideremovedown")),
        "parallaxhorizontal" == o &&
          ((o = "parallaxtoleft"), 1 == i && (o = "parallaxtoright")),
        "parallaxvertical" == o &&
          ((o = "parallaxtotop"), 1 == i && (o = "parallaxtobottom")),
        "random" == o &&
          ((o = Math.round(Math.random() * x.length - 1)),
          o > x.length - 1 && (o = x.length - 1)),
        "random-static" == o &&
    ...
    i = function (t, i, n, r, s, l, d, h, c) {
      var f = l.index(),
        p = s.index(),
        u = f > p ? 1 : 0;
      "arrow" == r.sc_indicator &&
        (0 == f && p == r.slideamount - 1 && (u = 1),
        f == r.slideamount - 1 && 0 == p && (u = 0));
      var g = o(n, r, i, d, u),
        v = g.STA,
        w = g.specials,
        t = g.nexttrans;
          ...
          P++,
            c.add(
              punchgs.TweenLite.fromTo(
                ...
                { autoAlpha: 1, ease: x, delay: (5 * t) / 1e3 }
              ),
              0
            );
        });
        ...
        26 == t && (y = 0),
          c.add(
            punchgs.TweenLite.fromTo(
              ...
              y / 1e3,
              { autoAlpha: 0 },
              { autoAlpha: 1, force3D: "auto", ease: x }
            ),
            0
          ),
          c.add(
        ...
        d.find(".slotslide").each(function () {
          ...
          1 != u
            ? ((U = -r.width),
              (K = 90),
              25 == t
                ? ((R = "center top 0"), (W = -K), (K = r.rotate))
                : ((R = "left center 0"), (W = r.rotate)))
            : ((U = r.width),
              (K = -90),
              25 == t
                ? ((R = "center bottom 0"), (W = -K), (K = r.rotate))
                : ((R = "right center 0"), (W = r.rotate))),
          h.find(".slotslide").each(function () {
            var t = jQuery(this);
            c.add(
              punchgs.TweenLite.fromTo(
              ...
              23 == t &&
                c.add(
                  punchgs.TweenLite.fromTo(
                    ...
                    y / 2e3,
                    { autoAlpha: 1 },
                    { autoAlpha: 0, delay: (50 * e) / 500 + y / 3e3, ease: T }
                  ),
                  0
                );
          });
