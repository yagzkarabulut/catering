      ...
      var s = o.data("videoattributes"),
        ...
        y =
          void 0 != u || void 0 != c
            ...
            : "none",
        w =
          "html5" == y && 0 == o.find("video").length
            ? "html5"
            : "youtube" == y && 0 == o.find("iframe").length
            ? "youtube"
            : "vimeo" == y && 0 == o.find("iframe").length
            ? "vimeo"
            : "none";
      switch ((o.data("videotype", y), w)) {
        case "html5":
          ...
          void 0 != c &&
            ...
            (b = b + '<source src="' + c + '" type="video/webm" />'),
            void 0 != u &&
              (b = b + '<source src="' + u + '" type="video/mp4" />'),
            void 0 != f &&
              (b = b + '<source src="' + f + '" type="video/ogg" />'),
            (b += "</video>"),
            "controls" == m &&
              (b +=
