            ...
            var h =
              ...
              f =
                "scroll_under" === u
                  ...
                  : '[{"event":"click","action":"jumptoslide","slide":"2","delay":"0.2"}]';
            (h =
              "no" == u
                ? h + ' data-start="0">'
    ...
    v = function (e, a) {
      if ((l(a), !i.resizeThumbsTabs || i.resizeThumbsTabs(a) === !0)) {
        if (
          (g(e, a, !0),
          f(a),
          "carousel" == a.sliderType && i.prepareCarousel(a, !0),
          e === t)
        )
          return !1;
        ...
        w(e, a, e, 2),
          "standard" === a.sliderType &&
            (punchgs.TweenLite.set(o.find(".defaultimg"), { opacity: 0 }),
          ...
          i.animateTheCaptions &&
            i.animateTheCaptions(e.find(".active-revslide"), a, !0),
          "on" == o.data("kenburns") &&
            i.startKenBurn(o, a, o.data("kbtl").progress()),
          "on" == n.data("kenburns") &&
            i.startKenBurn(n, a, n.data("kbtl").progress());
      }
    },
    m = function (e) {
